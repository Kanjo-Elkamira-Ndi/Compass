  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <motion.div
        ...
        style={{
          background:
            "conic-gradient(from 180deg at 50% 50%, hsl(var(--primary)/0.04) 0deg, transparent 60deg, hsl(var(--secondary)/0.03) 120deg, transparent 180deg, hsl(var(--primary)/0.02) 240deg, transparent 300deg, hsl(var(--primary)/0.04) 360deg)",
        }}
        animate={{ rotate: 360 }}
